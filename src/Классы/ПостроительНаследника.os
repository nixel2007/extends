...
Функция МетодУжеОпределенВНаследнике(МетодРодителя)
	Возврат (МетодРодителя.ЭтоФункция И _РефлекторОбъекта.ЕстьФункция(МетодРодителя.Имя, МетодРодителя.КоличествоПараметров))
		ИЛИ (НЕ МетодРодителя.ЭтоФункция И _РефлекторОбъекта.ЕстьПроцедура(МетодРодителя.Имя, МетодРодителя.КоличествоПараметров));
КонецФункции
